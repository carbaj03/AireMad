package com.acv.airmad.ui.behavior;
...
public class BottomSheetBehaviorGoogleMapsLike<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehaviorGoogleMapsLike(Context context, AttributeSet attrs ) {
        ...
        mAnchorPoint = getAnchor(attrs, context.obtainStyledAttributes(attrs, R.styleable.CustomBottomSheetBehavior));
        a.recycle();
    ...
    private int getAnchor(AttributeSet attrs,TypedArray typedArray ) {
        int defaultAnchorPoint = DEFAULT_ANCHOR_POINT;
        if (attrs != null)
            defaultAnchorPoint = (int) typedArray.getDimension( R.styleable.CustomBottomSheetBehavior_anchorPoint, 0);
    ...
    public void onRestoreInstanceState(CoordinatorLayout parent, V child, Parcelable state ) {
        ...
        mState = getStateRestoredAsCollapsed(ss);
        mLastStableState = mState;
    }

    public int getStateRestoredAsCollapsed(SavedState ss){
        return ss.state == STATE_DRAGGING || ss.state == STATE_SETTLING ?
            STATE_COLLAPSED : ss.state;
    }
     ...
     */
    @State
    public final int getStateRestoredAsCollapsed() {
        return mState;
    }
